...
if __name__ == "__main__":
    ...
    state_dict = torch.load("DecoderOnly_32_layers_15_epochs_70_1024.pth",map_location=torch.device(device))
    ...
    validator.markov_model_validation("out/generated_DecoderOnly_32_layers_15_epochs_70_1024.csv")
    validator.sequence_length_validation("out/generated_DecoderOnly_32_layers_15_epochs_70_1024.csv")
    validator.sequence_digit_stats("out/generated_DecoderOnly_32_layers_15_epochs_70_1024.csv")
    validator.log_prob_distribution_of_sequences("out/generated_DecoderOnly_32_layers_15_epochs_70_1024.csv")
