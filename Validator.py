...
if __name__ == "__main__":
    ...
    state_dict = torch.load("DecoderOnly_32_layers_15_epochs_400_ff_1024_dynamic.pth",map_location=torch.device(device))
    ...
    validator.markov_model_validation("out/generated_transformer_32_15_400_1024_dynamic_10000.csv")
    validator.sequence_length_validation("out/generated_transformer_32_15_400_1024_dynamic_10000.csv")
    validator.sequence_digit_stats("out/generated_transformer_32_15_400_1024_dynamic_10000.csv")
    validator.log_prob_distribution_of_sequences("out/generated_transformer_32_15_400_1024_dynamic_10000.csv")
    validator.plot_stats()
    validator.save_stats("out/stats_generated_transformer_32_15_400_1024_dynamic_10000.json")
