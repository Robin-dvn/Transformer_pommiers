...
if __name__ == "__main__":
    ...
    for layers, ff in couple_l_ff:
        ...
        validator_cyclical = train_generate_validate_pipeline(config_cyclical,sync_wandb=True)
        ...
        validator_early = train_generate_validate_pipeline(config_early,sync_wandb=True)
