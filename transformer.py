...
class Transformer(nn.Module):
    ...
    def __init__(self,in_vocab_size,out_vocab_size,d_model,n_head,padding_idx) -> None:
        ...
        self.transformer = nn.Transformer(d_model,n_head,batch_first=True)
    ...
    def forward(self,src,tgt,tgt_key_padding_mask):
        ...
        print(tgt.shape)
        out_trans = self.transformer(s_p_emb,t_p_emb,tgt_mask = nn.Transformer.generate_square_subsequent_mask(tgt.shape[1]), tgt_is_causal = True,tgt_key_padding_mask =tgt_key_padding_mask )
